...
Welcome to SketchwareX Pro! Here you'll find the source code of many classes in SketchwareX Pro and, most importantly, the place to contribute to SketchwareX Pro.
...
| `a.a.a.yq`      | Organizes SketchwareX Projects' file paths    |
...
If you'd like to contribute to SketchwareX Pro, follow these steps:
...
Thank you for contributing to SketchwareX Pro! Your contributions help keep SketchwareX Pro alive. Each accepted contribution will be noted down in the "About Modders" activity. We'll use your GitHub name and profile picture initially, but they can be changed, of course.
...
We do NOT permit publishing SketchwareX Pro as it is, or with modifications, on Play Store or on any other app store. Keep in mind that this project is still a mod. Unauthorized modding of apps is considered illegal and we discourage such behavior.
