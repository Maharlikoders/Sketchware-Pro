...
public class ProguardHandler {
    ...
    public ProguardHandler(String sc_id) {
        ...
        config_path = FileUtil.getExternalStorageDir() + "/" + SketchFileUtil.SKETCHWARE_WORKSPACE_DIRECTORY + "/data/" + sc_id + "/proguard";
        fm_config_path = FileUtil.getExternalStorageDir() + "/" + SketchFileUtil.SKETCHWARE_WORKSPACE_DIRECTORY + "/data/" + sc_id + "/proguard_fm";
    ...
    private static String createAndroidRules() {
        String rulePath = FileUtil.getExternalStorageDir() + "/" + SketchFileUtil.SKETCHWARE_WORKSPACE_DIRECTORY + "/libs/android-proguard-rules.pro";
    ...
    private static String createDefaultRules(String sc_id) {
        String path = FileUtil.getExternalStorageDir() + "/" + SketchFileUtil.SKETCHWARE_WORKSPACE_DIRECTORY + "/data/" + sc_id + "/proguard-rules.pro";
