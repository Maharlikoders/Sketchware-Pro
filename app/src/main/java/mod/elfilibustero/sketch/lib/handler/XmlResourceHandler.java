...
public class XmlResourceHandler {
    ...
    private final yq sourceCodeMaker;
    ...
    public List<Map<String, Object>> parseResourceFile(String file) {
        List<? extends Map<String, Object>> list = new ArrayList<>();
    ...
    public String getColorsXml() {
        ...
        List<Map<String, Object>> colors = parseResourceFile(XmlResourceConstant.getFileName(XmlResourceConstant.TYPE_COLOR));
        if (colors == null || colors.isEmpty()) {
            colors = getDefaultColorsXml();
        }
    ...
    public String getStringsXml() {
        ...
        List<Map<String, Object>> strings = parseResourceFile(XmlResourceConstant.getFileName(XmlResourceConstant.TYPE_STRING));
        if (strings == null || strings.isEmpty()) {
            strings = getDefaultStringsXml();
        }
    ...
    public String getStylesXml() {
        ...
        List<Map<String, Object>> styles = parseResourceFile(XmlResourceConstant.getFileName(XmlResourceConstant.TYPE_STYLE));
        if (styles == null || styles.isEmpty()) {
            styles = getDefaultStylesXml();
        }
    ...
    public List<Map<String, Object>> getDefaultColorsXml() {
    ...
    public List<Map<String, Object>> getDefaultStringsXml() {
    ...
    public List<Map<String, Object>> getDefaultStylesXml() {
