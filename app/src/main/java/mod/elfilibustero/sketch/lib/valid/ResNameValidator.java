...
public class ResNameValidator extends MB {
    ...
    private final Pattern namePattern = Pattern.compile("^[a-zA-Z][a-zA-Z0-9._]*$");
    private int resType;
    ...
    public void onTextChanged(CharSequence charSequence, int n, int n2, int n3) {
        ...
        if (resType != XmlResourceConstant.TYPE_STYLE && resType != XmlResourceConstant.TYPE_STYLE_ITEM) {
